...
pub const CENTER_CONTROL: EScore = S(5, 2);
...
pub const PAWN_PST: SquareMap<EScore> = SquareMap::from_array([                                                                                                            
    ...
    S(  22,   32), S(  29,   31), S(  26,   22), S(  32,   22), S(  34,   24), S(  25,   21), S(  22,   21), S(  15,   22),                                                 
    S(   1,   29), S(   9,   22), S(  10,    8), S(   6,  -12), S(  17,   -8), S(  16,   -1), S(   5,   10), S(  -7,   14),                                                 
    S( -13,    7), S( -17,    2), S(   2,   -9), S(  22,  -20), S(  20,  -18), S(  10,  -17), S( -20,    0), S( -21,   -7),                                                 
    S( -23,   -5), S( -27,   -6), S(  -2,  -19), S(  19,  -23), S(  11,  -19), S(  11,  -23), S( -15,  -17), S( -23,  -18),                                                 
    S( -18,  -16), S( -25,  -10), S( -12,  -17), S(  -9,   -9), S(  -3,   -9), S(   1,  -16), S(   7,  -22), S( -11,  -26),                                                 
    S( -31,  -15), S( -21,  -19), S( -22,  -11), S( -30,  -10), S( -23,   -4), S(  -1,  -14), S(  10,  -26), S( -26,  -35),                                                 
    S(   0,    0), S(   0,    0), S(   0,    0), S(   0,    0), S(   0,    0), S(   0,    0), S(   0,    0), S(   0,    0),                                                 
]);
#[rustfmt::skip]                                                                                                                                                            
pub const KNIGHT_PST: SquareMap<EScore> = SquareMap::from_array([                                                                                                          
    S( -10,   -6), S( -11,  -10), S(  -7,   -7), S(  -9,  -11), S(  -4,   -5), S(  -8,  -11), S(  -9,  -10), S( -10,   -7),                                                 
    S( -11,   -6), S(   0,    1), S(  12,   -1), S(  16,   11), S(  11,    7), S(  11,    2), S(  -1,   -1), S(  -9,  -11),                                                 
    S( -12,  -11), S(   7,    0), S(  11,   12), S(  19,   13), S(  21,   11), S(  17,   10), S(   8,    0), S(  -6,   -7),                                                 
    S(  -4,    1), S(  19,    8), S(  13,   15), S(  31,   22), S(  24,   20), S(  22,   15), S(  12,   12), S(   2,   -2),                                                 
    S(  13,    1), S(   3,    1), S(   5,   13), S(  16,   26), S(  26,   15), S(  27,   16), S(   8,    5), S(  21,    5),                                                 
    S(  16,   -7), S(  -4,    2), S(   6,   -1), S(   4,    9), S(  16,    9), S(  22,    0), S(  29,   -2), S(  12,   -4),                                                 
    S(  -7,   -7), S(  -3,   -3), S( -10,   -5), S(  17,   -5), S(  18,   -2), S(  11,   -4), S(   1,    1), S(   7,   -5),                                                 
    S( -10,   -6), S(  11,   -7), S( -16,  -11), S( -11,   -7), S(  -2,   -4), S( -11,   -9), S(  11,   -6), S(  -7,   -8),                                                 
]);
#[rustfmt::skip]                                                                                                                                                            
pub const BISHOP_PST: SquareMap<EScore> = SquareMap::from_array([                                                                                                          
    S( -10,   -8), S(  -7,   -6), S( -11,  -12), S( -12,  -10), S(  -9,   -8), S(  -8,   -9), S(  -7,   -5), S( -11,   -8),                                                 
    S(  -7,   -1), S(   0,    2), S(   1,    3), S(   4,   -2), S(   8,    7), S(   4,    4), S(  -1,    6), S( -21,  -10),
    S(  -7,    2), S(   7,    5), S(   4,    4), S(  15,    6), S(  15,    9), S(  14,   10), S(   6,    8), S(  -1,    4),
    S(  -6,    1), S( -18,    9), S(   2,    6), S(  13,    5), S(   7,    3), S(   8,    8), S( -11,    0), S(   1,    3),
    S(  -6,   -3), S(   0,    6), S( -16,   15), S(   1,    6), S(   7,    1), S(  -8,    6), S(   0,    1), S(  -2,   -1),
    S(  -7,   -2), S(  11,    9), S(  -4,    8), S( -11,    9), S(  -1,    9), S(  16,    4), S(  15,    7), S(  -4,    0),
    S(  -4,   -6), S(  12,   -3), S(   6,   -2), S(  -6,    2), S(   3,    6), S(   8,    4), S(  38,   -2), S(  -6,  -12),
    S(  -8,   -9), S(  -4,   -3), S(   5,    0), S(  -7,   -1), S(  -3,    0), S(  16,   -8), S(  -9,   -7), S(  -7,   -6),
]);
#[rustfmt::skip]
pub const ROOK_PST: SquareMap<EScore> = SquareMap::from_array([
    S(  14,   17), S(  18,   18), S(  14,   17), S(  17,   14), S(  19,   13), S(  18,   20), S(  17,   18), S(  16,   17),
    S(  21,   25), S(  18,   25), S(  21,   22), S(  23,   17), S(  21,   11), S(  21,   17), S(  16,   22), S(  22,   24),
    S(   3,   16), S(   6,   18), S(   6,   12), S(   7,    9), S(   6,    7), S(   1,    5), S(   3,   10), S(   3,   10),
    S(  -1,   13), S(   1,    9), S(   2,   13), S(   7,    7), S(   2,    4), S(   3,    9), S(  -1,    2), S(  -2,    9),
    S( -13,    6), S(  -4,    7), S(  -2,    6), S(  -3,    0), S(   0,    0), S(  -2,    2), S(   0,    3), S(  -7,   -1),
    S( -14,    1), S(  -3,    1), S(  -5,   -7), S(   1,   -2), S(  -1,   -9), S(   0,   -2), S(   1,    2), S( -16,   -8),
    S( -19,    2), S(  -4,   -2), S(  -4,    0), S(   5,    1), S(   5,   -5), S(   4,   -3), S(  -5,   -7), S( -33,   -2),
    S(   9,    0), S(  -1,    5), S(  11,    4), S(  24,   -4), S(  20,   -6), S(  37,   -5), S( -22,    6), S(   9,  -15),
]);
#[rustfmt::skip]
pub const QUEEN_PST: SquareMap<EScore> = SquareMap::from_array([
    S( -23,  -16), S(  -4,   -4), S(  -3,   -1), S(  -3,   -3), S(   0,    0), S(  -1,   -1), S(  -2,   -2), S(  -7,   -3),
    S(  -9,   -5), S( -31,   -5), S(  -2,    1), S(   0,    4), S(   0,    2), S(   1,    2), S(   2,    3), S(   7,    3),
    S(  -6,   -3), S(  -2,   -1), S(  -7,    1), S(   2,    6), S(   2,    7), S(   4,    4), S(   1,    0), S(   9,    7),
    S(  -5,    3), S( -11,    2), S(  -4,    2), S( -11,    6), S(  -5,    5), S(   1,    7), S(   3,    7), S(  -6,    7),
    S(  -2,   -2), S(  -9,    2), S(  -5,    4), S( -15,    9), S(  -3,    8), S(   7,    8), S(   3,    6), S(   2,    4),
    S(  -5,   -3), S(  15,   -3), S(  -1,    4), S(   5,    4), S(   5,    6), S(  14,    9), S(  14,    5), S(   5,    3),
    S( -14,   -6), S(  -3,   -2), S(  15,   -7), S(  16,   -5), S(  29,   -2), S(  11,    3), S(  -1,   -3), S(   1,   -1),
    S(  -6,   -6), S(  -6,   -5), S(   4,   -1), S(  33,   -8), S(   4,    5), S(  -9,   -5), S(  -1,   -1), S(  -5,   -5),
]);
#[rustfmt::skip]
pub const KING_PST: SquareMap<EScore> = SquareMap::from_array([
    S(   0,  -18), S(   0,  -16), S(   0,  -17), S(   0,  -17), S(   0,  -16), S(   0,  -14), S(   0,  -14), S(   0,  -16),
    S(   0,  -18), S(   0,   -5), S(   1,   -7), S(   1,   -5), S(   1,   -4), S(   2,    1), S(   1,   -2), S(   0,  -12),
    S(   0,  -12), S(   2,   -4), S(   3,    2), S(   1,   -1), S(   2,    6), S(   5,   18), S(   5,   14), S(   1,  -10),
    S(   0,  -20), S(   2,    2), S(   2,    9), S(   2,   12), S(   2,   13), S(   3,   18), S(   4,   13), S(  -1,  -12),
    S(  -1,  -23), S(   1,  -13), S(   1,    6), S(   0,   12), S(   0,   15), S(   1,   14), S(   2,   -3), S(  -3,  -22),
    S(  -1,  -25), S(  -1,  -16), S(   3,    0), S(  -1,    7), S(   1,   12), S(   1,    7), S(   9,    1), S(  -2,  -23),
    S(  -5,  -33), S(   1,  -20), S(   0,   -9), S( -18,   -4), S( -21,    4), S(  -9,   -3), S(   6,  -16), S(  21,  -39),
    S( -12,  -41), S(   2,  -42), S(   5,  -33), S( -26,  -28), S(  13,  -41), S( -36,  -24), S(   5,  -46), S(  12,  -68),
]);
